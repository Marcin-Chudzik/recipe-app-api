...
def create_recipe(user: object, **params: Union[str, Any]) -> object:
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creating a recipe with new"""
        payload = {
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        ex_tag = Tag.objects.create(user=self.user, name='Indian')
        payload = {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('10'),
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.tags.count(), 2)
        self.assertIn(ex_tag, recipe.tags.all())
        for tag in payload['tags']:
            exists = recipe.tags.filter(
                name=tag['name'],
                user=self.user,
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 50,
            'price': Decimal('6.20'),
            'ingredients': [{'name': 'Apple'}, {'name': 'Rice'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 34,
            'price': Decimal('22.2'),
            'ingredients': [{'name': 'Meat'}, {'name': 'Fish'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        recipe1 = create_recipe(user=self.user, title='Thai Vegetables Curry')
        recipe2 = create_recipe(user=self.user, title='Fish Soup')
